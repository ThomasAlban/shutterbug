                                    ...
                                    <td class="wrapper">
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <p>
                                                        Someone requested that the username/password be reset for the Shutterbug account associated with this email
                                                        address.
                                                    </p>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td><a href="${resetLink}" target="_blank">Reset Username/Password</a></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </td>
                                                    ...
                                                    <p>
                                                        If this was a mistake, just ignore the email and nothing will happen.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
